...
__HELP__ = """
<blockquote>
<b>『 ʙᴀɴᴛᴜᴀɴ ᴛᴏxɪᴄ 』</b> </blockquote>
<blockquote>
<b>➢ ᴘᴇʀɪɴᴛᴀʜ:</b> <code>{0}ngentot</code> <b>ᴏʀ</b> <code>{0}ngatain</code>
  <i>coba aja sendiri</i>

<b>➢ ᴘᴇʀɪɴᴛᴀʜ:</b> <code>{0}goblok</code> <b>ᴏʀ</b> <code>{0}yatim</code>
   <i>coba aja sendiri</i>

<b>➢ ᴘᴇʀɪɴᴛᴀʜ:</b> <code>{0}kontol</code> <b>ᴏʀ</b> <code>{0}hina</code>
   <i>coba aja sendiri</i>

<b>➢ ᴘᴇʀɪɴᴛᴀʜ:</b> <code>{0}lay</code> <b>ᴏʀ</b> <code>{0}ngaca</code>
   <i>coba aja sendiri</i>

<b>➢ ᴘᴇʀɪɴᴛᴀʜ:</b> <code>{0}jamet</code> <b>ᴏʀ</b> <code>{0}hay</code>
   <i>coba aja sendiri</i>
   </blockquote>
"""
...
async def _(client, message):
    ...
    await asyncio.sleep(1)
    await message.edig("**BIAR MUKALU GAK DIHINA TERUS**")
    await asyncio.sleep(1)
...
@PY.UBOT("lay")
async def _(client, message):
    await message.edit("**Eh Kamu Cakep Cakep*")
    await asyncio.sleep(1.8)
...
@PY.UBOT("jamet")
async def _(client, message):
    await message.edit("**WOI**")
    await asyncio.sleep(1.5)
    await message.edit("**JAMET**")
    await asyncio.sleep(1.5)
    await message.edit("**CUMA MAU BILANG**")
    await asyncio.sleep(1.5)
    await message.edit("**GAUSAH SOK ASIK**")
    await asyncio.sleep(1.5)
    await message.edit("**EMANG KENAL?**")
    await asyncio.sleep(1.5)
    await message.edit("**GAUSAH REPLY**")
    await asyncio.sleep(1.5)
    await message.edit("**KITA BUKAN KAWAN**")
    await asyncio.sleep(1.5)
    await message.edit("**GAUSAH SOKAB**")
    await asyncio.sleep(1.5)
    await message.edit("**BOCAH KAMPUNG**")
    await asyncio.sleep(1.5)
    await message.edit("**DASAR JAMET ALAY**")
    await asyncio.sleep(1.5)
    await message.edit("**MENTAL TEMPE**")
    await asyncio.sleep(1.5)
    await message.edit("**LEMBEK NGENTOT🔥**")
  
@PY.UBOT("hay")
async def _(client, message):
    await message.edit("**HeHe**")
    await asyncio.sleep(1.5)
    await message.edit("**Cuma Punya Bilang**")
    await asyncio.sleep(1.5)
    await message.edit("**Yang Pake Bot ini**")
    await asyncio.sleep(1.5)
    await message.edit("**Ganteng Banget Tau**")
    await asyncio.sleep(1.5)
    await message.edit("**Gatau kan?**")
    await asyncio.sleep(1.5)
