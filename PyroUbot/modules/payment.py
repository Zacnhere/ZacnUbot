...
async def _(client, callback_query):
    ...
    try:
        ...
        pesan = await bot.ask(
            user_id,
            f"""
<blockquote><b>💬 sɪʟᴀʜᴋᴀɴ ᴍᴇʟᴀᴋᴜᴋᴀɴ ᴘᴇᴍʙᴀʏᴀʀᴀɴ</b>
            
<b>🏧 ʙᴀɴᴋ: 𝗗𝗮𝗻𝗮 </b>
<b>💳 ɴᴏ ʀᴇᴋ: <code>‪0895620112085</code></b>
<b>⚜️ ʟɪɴᴋ: <a href=https://link.dana.id/qr/3ger1sbp>ᴋʟɪᴋ ᴅɪsɪɴɪ</a></b></blockquote>
""",
            timeout=300,
        )
...
""",
            ...
            CONFIRM_PAYMENT.remove(get.id)
            buttons = [
                [InlineKeyboardButton("👮‍♀️ ᴀᴅᴍɪɴ", url="https://t.me/ZacnBoys")]
            ]
            return await bot.send_message(
                user_id,
                f"""
...
<b>‼️ Jɪᴋᴀ ᴘᴇᴍʙᴀʏᴀʀᴀɴ ᴀɴᴅᴀ ʙᴇʟᴜᴍ ᴅɪ ᴋᴏɴғɪʀᴍᴀsɪ sɪʟᴀʜᴋᴀɴ ʜᴜʙᴜɴɢɪ ᴀᴅᴍɪɴ</b></blockquote>
""",
                reply_markup=InlineKeyboardMarkup(buttons),
            )
...
async def _(client, callback_query):
    ...
    if query[0] == "success":
        buttons = [
            [InlineKeyboardButton("⚒️ ʙᴜᴀᴛ ᴜsᴇʀʙᴏᴛ ⚒️", callback_data="buat_ubot")],
        ]
...
""",
    ...
    if query[0] == "failed":
        ...
        await bot.send_message(
            get_user.id,
            """
<blockquote><b>❌ ᴘᴇᴍʙᴀʏᴀʀᴀɴ ᴀɴᴅᴀ ᴛɪᴅᴀᴋ ʙɪsᴀ ᴅɪᴋᴏɴꜰɪʀᴍᴀsɪ</b>

<b>💬 sɪʟᴀʜᴋᴀɴ ʟᴀᴋᴜᴋᴀɴ ᴘᴇᴍʙᴀʏᴀʀᴀɴ ᴅᴇɴɢᴀɴ ʙᴇɴᴀʀ</b></blockquote>
""",
            reply_markup=InlineKeyboardMarkup(buttons),
        )
        return await callback_query.edit_message_text(
            f"""
<blockquote><b>❌ {get_user.first_name} {get_user.last_name or ''} ᴛɪᴅᴀᴋ ᴅɪᴛᴀᴍʙᴀʜᴋᴀɴ ᴋᴇ ᴀɴɢɢᴏᴛᴀ ᴘʀᴇᴍɪᴜᴍ</b></blockquote>
""",
        )
    if query[0] == "home":
